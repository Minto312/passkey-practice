...
func (ahq *AuthHistoryQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (ahq *AuthHistoryQuery) FirstIDX(ctx context.Context) int {
...
func (ahq *AuthHistoryQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (ahq *AuthHistoryQuery) OnlyIDX(ctx context.Context) int {
...
func (ahq *AuthHistoryQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (ahq *AuthHistoryQuery) IDsX(ctx context.Context) []int {
	ids, err := ahq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//
//	var v []struct {
//		Method authhistory.Method `json:"method,omitempty"`
...
func (ahq *AuthHistoryQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*AuthHistory, init func(*AuthHistory), assign func(*AuthHistory, *User)) error {
	...
	nodeids := make(map[int][]*AuthHistory)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (ahq *AuthHistoryQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(authhistory.Table, authhistory.Columns, sqlgraph.NewFieldSpec(authhistory.FieldID, field.TypeInt))
	_spec.From = ahq.sql
	...
	if fields := ahq.ctx.Fields; len(fields) > 0 {
		...
		if ahq.withUser != nil {
			_spec.Node.AddColumnOnce(authhistory.FieldUserID)
		}
	}
