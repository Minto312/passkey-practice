...
import (
	...
	"github.com/Minto312/passkey-practice/backend/internal/infra/repository/ent/session"
...
func withAuthHistoryID(id int) authhistoryOption {
...
func (m *AuthHistoryMutation) ID() (id int, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *AuthHistoryMutation) IDs(ctx context.Context) ([]int, error) {
	switch {
...
func (m *AuthHistoryMutation) SetMethod(a authhistory.Method) {
	m.method = &a
}

// Method returns the value of the "method" field in the mutation.
func (m *AuthHistoryMutation) Method() (r authhistory.Method, exists bool) {
	v := m.method
	if v == nil {
		return
	}
...
func (m *AuthHistoryMutation) OldMethod(ctx context.Context) (v authhistory.Method, err error) {
...
func (m *AuthHistoryMutation) SetUserID(i int) {
	m.user = &i
}

// UserID returns the value of the "user_id" field in the mutation.
func (m *AuthHistoryMutation) UserID() (r int, exists bool) {
	v := m.user
	if v == nil {
		return
	}
...
// If the AuthHistory object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AuthHistoryMutation) OldUserID(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AuthHistoryMutation) UserIDs() (ids []int) {
	if id := m.user; id != nil {
		ids = append(ids, *id)
	}
	return
...
func (m *PasskeyMutation) SetPublicKey(s string) {
	m.public_key = &s
}

// PublicKey returns the value of the "public_key" field in the mutation.
func (m *PasskeyMutation) PublicKey() (r string, exists bool) {
	v := m.public_key
	if v == nil {
		return
	}
...
// If the Passkey object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *PasskeyMutation) OldPublicKey(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
type UserMutation struct {
	...
	auth_histories        map[int]struct{}
	removedauth_histories map[int]struct{}
...
func (m *UserMutation) AddAuthHistoryIDs(ids ...int) {
	if m.auth_histories == nil {
		m.auth_histories = make(map[int]struct{})
	}
	for i := range ids {
...
func (m *UserMutation) RemoveAuthHistoryIDs(ids ...int) {
	if m.removedauth_histories == nil {
		m.removedauth_histories = make(map[int]struct{})
	}
	for i := range ids {
