...
func (*AuthHistory) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case authhistory.FieldID, authhistory.FieldUserID:
	...
	for i := range columns {
		...
		case authhistory.FieldMethod:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				ah.Method = authhistory.Method(value.String)
			}
		case authhistory.FieldAuthenticatedAt:
...
func (ah *AuthHistory) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", ah.Method))
	builder.WriteString(", ")
