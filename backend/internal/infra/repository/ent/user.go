...
type UserEdges struct {
	...
	// AuthHistories holds the value of the auth_histories edge.
	AuthHistories []*AuthHistory `json:"auth_histories,omitempty"`
...
// was not loaded in eager-loading.
func (e UserEdges) AuthHistoriesOrErr() ([]*AuthHistory, error) {
	if e.loadedTypes[1] {
		return e.AuthHistories, nil
	}
	return nil, &NotLoadedError{edge: "auth_histories"}
}
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldEmail, user.FieldPassword, user.FieldDisplayName:
...
// QueryAuthHistories queries the "auth_histories" edge of the User entity.
func (u *User) QueryAuthHistories() *AuthHistoryQuery {
	return NewUserClient(u.config).QueryAuthHistories(u)
}
