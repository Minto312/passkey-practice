...
import (
	...
	"github.com/Minto312/passkey-practice/backend/internal/infra/repository/ent/migrate"
...
func (c *AuthHistoryClient) UpdateOneID(id int) *AuthHistoryUpdateOne {
...
func (c *AuthHistoryClient) DeleteOneID(id int) *AuthHistoryDeleteOne {
...
func (c *AuthHistoryClient) Get(ctx context.Context, id int) (*AuthHistory, error) {
	return c.Query().Where(authhistory.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AuthHistoryClient) GetX(ctx context.Context, id int) *AuthHistory {
