...
func (pu *PasskeyUpdate) AddUserIDs(ids ...uuid.UUID) *PasskeyUpdate {
	pu.mutation.AddUserIDs(ids...)
	return pu
}

// AddUser adds the "user" edges to the User entity.
func (pu *PasskeyUpdate) AddUser(u ...*User) *PasskeyUpdate {
...
func (pu *PasskeyUpdate) RemoveUserIDs(ids ...uuid.UUID) *PasskeyUpdate {
	pu.mutation.RemoveUserIDs(ids...)
	return pu
}

// RemoveUser removes "user" edges to User entities.
func (pu *PasskeyUpdate) RemoveUser(u ...*User) *PasskeyUpdate {
	ids := make([]uuid.UUID, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
// AddUserIDs adds the "user" edge to the User entity by IDs.
func (puo *PasskeyUpdateOne) AddUserIDs(ids ...uuid.UUID) *PasskeyUpdateOne {
	puo.mutation.AddUserIDs(ids...)
	return puo
}

// AddUser adds the "user" edges to the User entity.
func (puo *PasskeyUpdateOne) AddUser(u ...*User) *PasskeyUpdateOne {
	ids := make([]uuid.UUID, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
...
// RemoveUserIDs removes the "user" edge to User entities by IDs.
func (puo *PasskeyUpdateOne) RemoveUserIDs(ids ...uuid.UUID) *PasskeyUpdateOne {
	puo.mutation.RemoveUserIDs(ids...)
	return puo
}

// RemoveUser removes "user" edges to User entities.
func (puo *PasskeyUpdateOne) RemoveUser(u ...*User) *PasskeyUpdateOne {
	ids := make([]uuid.UUID, len(u))
	for i := range u {
		ids[i] = u[i].ID
	}
