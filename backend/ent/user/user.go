...
const (
	...
	Table = "users"
	// PasskeysTable is the table that holds the passkeys relation/edge. The primary key declared below.
...
var (
	// PasskeysPrimaryKey and PasskeysColumn2 are the table columns denoting the
	// primary key for the passkeys relation (M2M).
	PasskeysPrimaryKey = []string{"user_id", "passkey_id"}
)
